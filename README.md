...
Update log
    ...
    (ICEBOX)
      ...
      - New microarray functions:
        - New DE analysis function added: rbioarray_de_analysis()
          - The function has export options:
            (i) all features, 
    ...
    (ADDED)
      ...
      - General updates
        ...
        - Updated legacy functions to be compatiable with ggplot2 >= 3.5.0
    ...
    0.5.6 (Aug.31.2023)
      - Updates to GS function(s):
        ...
        - rbioGS_all() now supports custom file name prefix for the exported files
          - A bug fixed for the custom file name behavour for the exported scatter plot files
